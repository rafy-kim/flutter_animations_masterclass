...
class MusicPlayserScreen extends StatefulWidget {
  const MusicPlayserScreen({super.key});

  @override
  State<MusicPlayserScreen> createState() => _MusicPlayserScreenState();
}

class _MusicPlayserScreenState extends State<MusicPlayserScreen> {
